...
class DownloadFinam:
    def __init__(self, ticker, path_data, period=3):
...
if __name__ == "__main__":
    ...
    start = "08.01.2021"  # с какой даты начинать тянуть котировки
    end = "10.02.2021"  # финальная дата, по которую тянуть котировки
    ...
    data = DownloadFinam(ticker, path_data, period)  # Создаем экземпляр класса
